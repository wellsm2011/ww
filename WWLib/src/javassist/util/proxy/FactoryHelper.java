...
public class FactoryHelper
{
	...
	static
	{
		try
		{
			...
			FactoryHelper.defineClass1 = SecurityActions.getDeclaredMethod(cl, "defineClass", new Class[]
			{ String.class, byte[].class, int.class, int.class });

			FactoryHelper.defineClass2 = SecurityActions.getDeclaredMethod(cl, "defineClass", new Class[]
	...
	public static Class toClass(ClassFile cf, ClassLoader loader, ProtectionDomain domain) throws CannotCompileException
	{
		try
		{
			...
			if (domain == null)
			{
				...
				args = new Object[]
				{ cf.getName(), b, new Integer(0), new Integer(b.length) };
			} else
			{
				method = FactoryHelper.defineClass2;
				args = new Object[]
				{ cf.getName(), b, new Integer(0), new Integer(b.length), domain };
			}
