...
public class ClassPool
{
		...
		try
		{
			AccessController.doPrivileged(new PrivilegedExceptionAction()
			{
				...
				public Object run() throws Exception
				{
					...
					ClassPool.defineClass1 = cl.getDeclaredMethod("defineClass", new Class[]
					{ String.class, byte[].class, int.class, int.class });

					ClassPool.defineClass2 = cl.getDeclaredMethod("defineClass", new Class[]
					{ String.class, byte[].class, int.class, int.class, ProtectionDomain.class });

					ClassPool.definePackage = cl.getDeclaredMethod("definePackage", new Class[]
					{ String.class, String.class, String.class, String.class, String.class, String.class, String.class, java.net.URL.class });
					return null;
				}
			});
	...
	{
		this.classes = new Hashtable(ClassPool.INIT_HASH_SIZE);
	...
	void compress()
	{
		if (this.compressCount++ > ClassPool.COMPRESS_THRESHOLD)
		{
			this.compressCount = 0;
	...
	protected CtClass createCtClass(String classname, boolean useCache)
	{
		...
		} else if (this.find(classname) == null)
			return null;
		else
	...
	/**
	 * Creates a new annotation. If there already exists a class/interface with
	 * the same name, the new interface overwrites that previous one.
	 *
	 * @param name
	 *            a fully-qualified interface name. Or null if the annotation
	 *            has no super interface.
	...
	public void makePackage(ClassLoader loader, String name) throws CannotCompileException
	{
		...
		try
		{
			ClassPool.toClass2(ClassPool.definePackage, loader, args);
			return;
	...
	void recordCflow(String name, String cname, String fname)
	{
		...
		this.cflow.put(name, new Object[]
		{ cname, fname });
	}
	...
	public Class toClass(CtClass ct, ClassLoader loader, ProtectionDomain domain) throws CannotCompileException
	{
		try
		{
			...
			if (domain == null)
			{
				...
				args = new Object[]
				{ ct.getName(), b, new Integer(0), new Integer(b.length) };
			} else
			{
				method = ClassPool.defineClass2;
				args = new Object[]
				{ ct.getName(), b, new Integer(0), new Integer(b.length), domain };
			}
