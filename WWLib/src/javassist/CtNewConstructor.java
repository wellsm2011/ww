...
public class CtNewConstructor
{
	...
	{
		return CtNewConstructor.make(parameters, exceptions, CtNewConstructor.PASS_PARAMS, null, null, declaring);
	}
	...
	{
		return CtNewConstructor.make(parameters, exceptions, CtNewConstructor.PASS_NONE, null, null, declaring);
	}
}
