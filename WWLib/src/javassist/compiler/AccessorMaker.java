...
public class AccessorMaker
{
	...
	public String getConstructor(CtClass c, String desc, MethodInfo orig) throws CompileError
	{
		...
		consDesc = Descriptor.appendParameter(AccessorMaker.lastParamType, desc);
		ClassFile cf = this.clazz.getClassFile(); // turn on the modified flag.
		try
		{
			...
			code.addInvokespecial(this.clazz, MethodInfo.nameInit, desc);
