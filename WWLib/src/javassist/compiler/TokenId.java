...
public interface TokenId
{
	...
	int		assignOps[]		=
							{ '%', '&', '*', '+', '-', '/', 0, 0, 0, '^', '|', 0, 0, 0, TokenId.LSHIFT, 0, TokenId.RSHIFT, 0, 0, 0, TokenId.ARSHIFT };
	...
	int		EXPR			= 'E';																																			// expression
																																											// statement
	int		LABEL			= 'L';																																			// label
																																											// statement
	int		BLOCK			= 'B';																																			// block
																																											// statement
	int		DECL			= 'D';																																			// declaration
																																											// statement
