...
public abstract class Callback
{
	 ...
	 * is inserted just before every return instruction. It is not executed when
	 ...
	 * @param asFinally
	 *            True if the inserted is executed Not only when the control
	 ...
	 *            Can be one or many single statements each returning one
	 *            object. If many single statements are used they must be comma
	 *            separated.
	 */
