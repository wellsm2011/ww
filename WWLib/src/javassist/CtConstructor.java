...
public final class CtConstructor extends CtBehavior
{
	...
	public CtConstructor(CtClass[] parameters, CtClass declaring)
	{
		...
		this.setModifiers(Modifier.PUBLIC);
	}
	 ...
	 * <code>javassist.CtConstructor(CtClass[],CtClass)</code>.
	 *
	 * @since 3.5
	 */
	@Override
	...
	{
		return this.getDeclaringClass().getName() + (this.isConstructor() ? Descriptor.toString(this.getSignature()) : "." + MethodInfo.nameClinit + "()");
	}
