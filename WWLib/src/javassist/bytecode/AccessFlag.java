...
public class AccessFlag
{
	...
	public static final int	BRIDGE			= 0x0040;			// for
																// method_info
	public static final int	TRANSIENT		= 0x0080;
	public static final int	VARARGS			= 0x0080;			// for
																// method_info
	...
	{
		return (accflags & (AccessFlag.PROTECTED | AccessFlag.PUBLIC | AccessFlag.PRIVATE)) == 0;
	}
	...
	{
		return (accflags & AccessFlag.PRIVATE) != 0;
	}
	...
	{
		return (accflags & AccessFlag.PROTECTED) != 0;
	}
	...
	{
		return (accflags & AccessFlag.PUBLIC) != 0;
	}
	...
	{
		return accflags & ~(AccessFlag.PROTECTED | AccessFlag.PUBLIC | AccessFlag.PRIVATE);
	}
	...
	{
		return accflags & ~(AccessFlag.PRIVATE | AccessFlag.PUBLIC) | AccessFlag.PROTECTED;
	}
	...
	{
		return accflags & ~(AccessFlag.PRIVATE | AccessFlag.PROTECTED) | AccessFlag.PUBLIC;
	}
