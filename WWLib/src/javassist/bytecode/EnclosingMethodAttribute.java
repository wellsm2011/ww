...
public class EnclosingMethodAttribute extends AttributeInfo
{
	...
	{
		super(cp, EnclosingMethodAttribute.tag);
	...
	/**
	 * Returns the method name specified by <code>method_index</code>. If the
	 * method is a class initializer (static constructor),
