...
public class MapMaker extends Tracer
{
	 ...
	 * cp = ClassPool.getDefault(); //javassist.CtClass cc = cp.get(className);
	 ...
	 * ClassPool.getDefault(); //javassist.CtClass cc = cp.get(args[1]);
	 * javassist.CtClass cc = cp.makeClass(new
	 * java.io.FileInputStream(args[1])); MethodInfo minfo; if
