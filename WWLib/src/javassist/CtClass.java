...
public abstract class CtClass
{
	 ...
	 * Javassist are saved under the directory specified by this variable. For
	...
	static
	{
		...
		CtClass.booleanType = new CtPrimitiveType("boolean", 'Z', "java.lang.Boolean", "booleanValue", "()Z", Opcode.IRETURN, Opcode.T_BOOLEAN, 1);
		CtClass.primitiveTypes[0] = CtClass.booleanType;

		CtClass.charType = new CtPrimitiveType("char", 'C', "java.lang.Character", "charValue", "()C", Opcode.IRETURN, Opcode.T_CHAR, 1);
		CtClass.primitiveTypes[1] = CtClass.charType;

		CtClass.byteType = new CtPrimitiveType("byte", 'B', "java.lang.Byte", "byteValue", "()B", Opcode.IRETURN, Opcode.T_BYTE, 1);
		CtClass.primitiveTypes[2] = CtClass.byteType;

		CtClass.shortType = new CtPrimitiveType("short", 'S', "java.lang.Short", "shortValue", "()S", Opcode.IRETURN, Opcode.T_SHORT, 1);
		CtClass.primitiveTypes[3] = CtClass.shortType;

		CtClass.intType = new CtPrimitiveType("int", 'I', "java.lang.Integer", "intValue", "()I", Opcode.IRETURN, Opcode.T_INT, 1);
		CtClass.primitiveTypes[4] = CtClass.intType;

		CtClass.longType = new CtPrimitiveType("long", 'J', "java.lang.Long", "longValue", "()J", Opcode.LRETURN, Opcode.T_LONG, 2);
		CtClass.primitiveTypes[5] = CtClass.longType;

		CtClass.floatType = new CtPrimitiveType("float", 'F', "java.lang.Float", "floatValue", "()F", Opcode.FRETURN, Opcode.T_FLOAT, 1);
		CtClass.primitiveTypes[6] = CtClass.floatType;

		CtClass.doubleType = new CtPrimitiveType("double", 'D', "java.lang.Double", "doubleValue", "()D", Opcode.DRETURN, Opcode.T_DOUBLE, 2);
		CtClass.primitiveTypes[7] = CtClass.doubleType;

		CtClass.voidType = new CtPrimitiveType("void", 'V', "java.lang.Void", null, null, Opcode.RETURN, 0, 0);
	...
	/**
	 * Returns the immediately enclosing method of this class. It might be not a
	 * method but a constructor. This method works only with JDK 1.5 or later.
	 *
	 ...
	 * ClassSignature cs = new ClassSignature(new TypeParameter[]
	 * { new TypeParameter(&quot;T&quot;) });
	 ...
	 * MethodSignature ms2 = new MethodSignature(null, new Type[]
	 * { tvar }, new BaseType(&quot;void&quot;), null);
	 ...
	 * the specification of the signatures, see Section 4.7.9.1
	 * <i>Signatures</i> of The Java Virtual Machine Specification (Java SE 8).
	 *
	 * @param sig
	 *            a generic signature.
