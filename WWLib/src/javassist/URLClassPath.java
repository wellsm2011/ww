...
public class URLClassPath implements ClassPath
{
	 ...
	 * is "org.javassist." and a requested class is "org.javassist.test.Main",
	 * then the given URL is used for loading that class. The
	 * <code>URLClassPath</code> obtains a class file from:
	 *
	 * <pre>
