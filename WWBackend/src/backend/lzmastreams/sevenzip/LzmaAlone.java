package backend.lzmastreams.sevenzip;
...
public class LzmaAlone
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		if (params.Command == CommandLine.kBenchmak)
		{
			...
			backend.lzmastreams.sevenzip.LzmaBench.LzmaBenchmark(params.NumBenchmarkPasses, dictionary);
		} else if (params.Command == CommandLine.kEncode || params.Command == CommandLine.kDecode)
		{
			...
			{
				backend.lzmastreams.sevenzip.compression.lzma.Encoder encoder = new backend.lzmastreams.sevenzip.compression.lzma.Encoder();
			...
			} else
			{
				...
				backend.lzmastreams.sevenzip.compression.lzma.Decoder decoder = new backend.lzmastreams.sevenzip.compression.lzma.Decoder();
