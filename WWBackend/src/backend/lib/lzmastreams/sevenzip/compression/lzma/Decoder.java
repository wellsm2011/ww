...
import backend.lib.lzmastreams.sevenzip.compression.lz.OutWindow;
import backend.lib.lzmastreams.sevenzip.compression.rangecoder.BitTreeDecoder;
...
public class Decoder
{
	class LenDecoder
	{
		...
		public int Decode(backend.lib.lzmastreams.sevenzip.compression.rangecoder.Decoder rangeDecoder, int posState) throws IOException
		{
		...
		public void Init()
		{
			backend.lib.lzmastreams.sevenzip.compression.rangecoder.Decoder.InitBitModels(this.m_Choice);
	...
	class LiteralDecoder
	{
		class Decoder2
		{
			...
			public byte DecodeNormal(backend.lib.lzmastreams.sevenzip.compression.rangecoder.Decoder rangeDecoder) throws IOException
			{
				int symbol = 1;
				do
			...
			public byte DecodeWithMatchByte(backend.lib.lzmastreams.sevenzip.compression.rangecoder.Decoder rangeDecoder, byte matchByte) throws IOException
			{
				int symbol = 1;
				do
				{
			...
			public void Init()
			{
				backend.lib.lzmastreams.sevenzip.compression.rangecoder.Decoder.InitBitModels(this.m_Decoders);
			}
		}
	...
	backend.lib.lzmastreams.sevenzip.compression.rangecoder.Decoder	m_RangeDecoder			= new backend.lib.lzmastreams.sevenzip.compression.rangecoder.Decoder();
	...
	void Init() throws IOException
	{
		...
		backend.lib.lzmastreams.sevenzip.compression.rangecoder.Decoder.InitBitModels(this.m_IsMatchDecoders);
		backend.lib.lzmastreams.sevenzip.compression.rangecoder.Decoder.InitBitModels(this.m_IsRep0LongDecoders);
		backend.lib.lzmastreams.sevenzip.compression.rangecoder.Decoder.InitBitModels(this.m_IsRepDecoders);
		backend.lib.lzmastreams.sevenzip.compression.rangecoder.Decoder.InitBitModels(this.m_IsRepG0Decoders);
		backend.lib.lzmastreams.sevenzip.compression.rangecoder.Decoder.InitBitModels(this.m_IsRepG1Decoders);
		backend.lib.lzmastreams.sevenzip.compression.rangecoder.Decoder.InitBitModels(this.m_IsRepG2Decoders);
		backend.lib.lzmastreams.sevenzip.compression.rangecoder.Decoder.InitBitModels(this.m_PosDecoders);
