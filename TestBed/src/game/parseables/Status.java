...
public class Status
{
	...
	@ExportedParam(storetype = SType.LIST, dataType = "string", key = "actionMods", methodtype = MType.GETTER, sortVal = 3)
	public List<String> getActionModifierList()
	{
		return this.actionMods;
	}

	@ExportedParam(storetype = SType.MAP, dataType = "string", key = "application", methodtype = MType.GETTER, sortVal = 4)
	public Map<String, String> getApplicationData()
	{
		return this.application;
	}

	@ExportedParam(storetype = SType.LIST, dataType = "string", key = "onEndActions", methodtype = MType.GETTER, sortVal = 5)
	public List<String> getOnEndActionList()
	{
		return this.onEndActions;
	}

	@ExportedParam(storetype = SType.MAP, dataType = "string", key = "onEndAtomics", methodtype = MType.GETTER, sortVal = 6)
	...
	@ExportedParam(storetype = SType.LIST, dataType = "string", key = "actionMods", methodtype = MType.SETTER, sortVal = 3)
	public void setActionModifierList(List<String> input)
	{
		this.actionMods = input;
	}

	@ExportedParam(storetype = SType.MAP, dataType = "string", key = "application", methodtype = MType.SETTER, sortVal = 4)
	public void setApplicationData(Map<String, String> input)
	{
		this.application = input;
	}

	@ExportedParam(storetype = SType.LIST, dataType = "string", key = "onEndActions", methodtype = MType.SETTER, sortVal = 5)
	public void setOnEndActionList(List<String> input)
	{
		this.onEndActions = input;
	}

	@ExportedParam(storetype = SType.MAP, dataType = "string", key = "onEndAtomics", methodtype = MType.SETTER, sortVal = 6)
