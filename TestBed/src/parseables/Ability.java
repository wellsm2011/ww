...
public class Ability
{
	...
	@ExportedParam(storetype = SType.MAP, key = "targeting", methodtype = MType.GETTER, sortVal = 3)
	...
	@ExportedParam(storetype = SType.LIST, key = "appliedActions", methodtype = MType.SETTER, sortVal = 4)
	public void setAppliedActions(List<String> input)
	{
		this.appliedActions = input;
	}

	@ExportedParam(storetype = SType.MAP, key = "appliedAtomics", methodtype = MType.SETTER, sortVal = 5)
	public void setAppliedAtomics(Map<String, String> input)
	{
		this.appliedAtomics = input;
	}

	@ExportedParam(storetype = SType.LIST, key = "tags", methodtype = MType.SETTER, sortVal = 1)
	public void setTags(List<String> input)
	{
		this.tags = input;
	}

	@ExportedParam(storetype = SType.MAP, key = "targeting", methodtype = MType.SETTER, sortVal = 3)
