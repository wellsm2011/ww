...
public class GameCon
{
	...
	@ExportedParam(storetype = SType.MAP, key = "resultAtomics", methodtype = MType.GETTER, sortVal = 2)
	public Map<String, String> getAppliedAtomics()
	{
		return this.resultAtomics;
	}

	@ExportedParam(storetype = SType.MAP, key = "trigger", methodtype = MType.GETTER, sortVal = 1)
	public Map<String, String> getTriggerData()
	{
		return this.triggerData;
	}

	@ExportedParam(storetype = SType.MAP, key = "resultAtomics", methodtype = MType.SETTER, sortVal = 2)
	public void setAppliedAtomics(Map<String, String> input)
	{
		this.resultAtomics = input;
	}

	@ExportedParam(storetype = SType.MAP, key = "trigger", methodtype = MType.SETTER, sortVal = 1)
